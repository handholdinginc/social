    ...
    render() {
		...
		<header className="pt-195 pb-110 header_1">
			...
			<div className="row justify-content-center justify-content-md-between align-items-center">
				...
				<img src="i/hhs-phone.png" className="img-fluid application_2_left_img hshadow" data-aos="fade-down" data-aos-delay="500"/>
			    </div>
			</div>
		    </div>
		</header>
...
Stream your content to your audience, using your own custom emoji and a secure streaming key. Grow your followers on your personal microblog, and stream to them on the streaming service. With Handholding Social, you're in control.
			    ...
			    <img src="i/hhs-streaming.png" alt="" className="img-fluid application_2_left_img" data-aos="fade-down" data-aos-delay="500"/>	                            </div>
	    </section>
		...
		<div className="container px-xl-0">
		    ...
		    <div className="row justify-content-center justify-content-md-between align-items-center">
			<div className="mb-15 mb-md-0 col-12 col-md-5 col-xl-6 d-flex justify-content-center">
			    <img src="i/hhs-filters.png" alt="" className="img-fluid application_2_left_img" data-aos="fade-down" data-aos-delay="500"/>
			</div>
			<div className="col-md-7 col-xl-6">
			    <h2 className="col-lg-11 color-main" data-aos="fade-down" data-aos-delay="0">
		...
		<div className="container px-xl-0">
			...
			<div className="mb-15 mb-md-0 col-12 col-md-5 col-xl-6 d-flex justify-content-center">
			    <img src="i/hhs-chats.png" alt="" className="img-fluid application_2_left_img" data-aos="fade-down" data-aos-delay="500"/>
			</div>
		...
		<div className="container px-xl-0">
			...
			<div className="mb-15 mb-md-0 col-12 col-md-5 col-xl-6 d-flex justify-content-center">
			    <img src="i/handholding-logo.png"  alt="" className="img-fluid application_2_left_img" data-aos="fade-down" data-aos-delay="500"/>
			</div>
